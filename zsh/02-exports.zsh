...
export PATH="$( echo \
  ...
  /home/gsacre/.gem/ruby/1.9.1/bin:\
...
export EDITOR=gvim
export EMAIL="gsa@softkinetic.com"
export FULLNAME="Gregory SACRE"
...
export HISTFILE=$HOME/.zsh_cache/history
...
if [ `env | grep DISPLAY | grep -v grep | wc -l` -gt 0 ]; then
  export TERM=xterm-256color
fi

# SK specific
export DEPENDENCIESDIR=/home/gsacre/DevRoot/Dependencies
export DEVROOT=/home/gsacre/DevRoot
export IISU_BIN_DIR=/home/gsacre/DevRoot/bin

export GITODO_DATA=/home/gsacre/SpiderOak/gitodo.items
