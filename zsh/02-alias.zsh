...
alias cdlf='sudo tail -f /var/log/everything.log'

alias namuga='cd /opt/Namuga'
alias fellini='cd /opt/fellini-linux/api/linux'
alias belgacom='cd /opt/belgacom_received'
alias cdaf="cd /var/log/apache2/ && tail -f error_log"
alias cda='cd /var/log/apache2'
alias opengles='cd /opt/refsw/rockford/applications/opengles/OpengESTestBed'

alias ls="ls++"
alias ll="/bin/ls --color=auto -ltr"
alias lm="ls++ | more"
alias ftp="gftp-text"
#alias mutt="export LC_ALL=fr_FR && mutt"
alias alcatel="remind-me -f ~/.alcatel/alcatel.rdb"
alias howto="remind-me -f ~/.howto/howto.rdb"
alias nzbget="nice -n 10 nzbget"
...
alias startxl="startx >~/logs/startx.log 2>&1"
#alias startxagp="startx -- -layout Simple_Layout_AGP >~/logs/startx.log 2>&1"
alias pm-hibernate="sudo /usr/sbin/pm-hibernate;xmodmap /etc/xmodmap"
alias git-kompare="git-diff -E -b -w --no-color --unified=99999 $* | kompare -"
alias vi="gvim -p"
#alias vi="subl"
alias gvi="gvim -p"

#alias firefox="export XLIB_SKIP_ARGB_VISUALS=1 ; firefox"
alias print-2-per-page="lpr -o media=A4 -o number-up=2 -o page-left=72 -o page-right=72 -o job-sheets=none -o prettyprint"

#alias skype='amixer cset numid=8 23 && skype && amixer cset numid=8 0'

#alias urxvt="screen urxvt"
#alias irssi="screen irssi -c localhost -n Greg"

alias df='pydf'

alias gtd='yagtd -c ~/doc/gtd/todo.txt'
...
alias     lspci='$HOME/bin/cope/lspci'
alias     lsusb='$HOME/bin/cope/lsusb'
alias    md5sum='$HOME/bin/cope/md5sum'
alias      ping='$HOME/bin/cope/ping'
alias     route='$HOME/bin/cope/route'
alias       top='htop'
...
alias skvpn='curdir=`pwd`; cd ~/openvpn/; sudo openvpn --client --up ./clientup.sh --down ./clientdown.sh  --config client.crssl; cd "$curdir"'

alias mc='mc --skin modarin256'
alias gitodo='EDITOR="gvim -f" gitodo'
